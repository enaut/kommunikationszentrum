...
- **Category Tabs**: Topics are organized into category tabs (e.g. *Verteilpunkt*, *Arbeitsgruppe*, and untagged *Sonstige*).
- **Inline Email Checkboxes**: Each topic card displays an inline checklist of all email addresses linked to the member's account.
  - **Multi-Email Subscriptions**: Members can subscribe one, several, or all of their linked addresses to a topic independently.
...
- **Status & Verification Badges**:
  - `Subscribed` (Green header badge): Appears on the topic card whenever at least one email of the account is actively subscribed.
...
## 3. Topic Detail & Subscriber Administration

Within each topic's detail view, administrators manage subscribers and permission tiers:
...
- **Adding Subscribers**:
  ...
  - **Smart Filtering**: The member selector only shows members who have at least one verified email not yet subscribed to the topic.
