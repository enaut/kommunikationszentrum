...
| `MAIL_UNSUBSCRIBE_BASE_URL` | `FRONTEND_BASE_URL` (default: `http://127.0.0.1:8080`) | Base URL for one-click unsubscribe links in outbound mail |
...
MAIL_UNSUBSCRIBE_BASE_URL=https://admin.example.org
